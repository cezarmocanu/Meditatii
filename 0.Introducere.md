...
*Nota:*
>vom intalni de cele mai multe ori variabile scrise sub forma <br/>
>numeLungDeVariabila - camelCase (deoarece literele mari sunt ca si cocoasele unei camile)<br/>
>nume_lung_de_variabila - snakeCase (deoarece numele variabilei este separat de _ si se aseamana cu un sarpe<br/>
...
De asemenea exista o oridne si pentru operatiile logice aceasta este 
...
>Scrieti rezultatul urmatoarelor expresii matematice pentru x = 5
>a) (x > 3) && (x < 9)
>b) (x == 5) || (x ==9)
>c) (x * x > 25) && ((x < 9) || (x > 3))
